...
local Assets = import("rbxassetid://10924729710").UpvalueScanner
...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Upbolt/Hydroxide/revision/ohaux.lua"))()
